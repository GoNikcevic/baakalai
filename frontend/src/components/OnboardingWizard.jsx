...
const CRM_GUIDES = {
  ...
  salesforce: {
    guideFr: [
      'Dans Salesforce : Configuration \u2192 Ouvrir la configuration avanc\u00E9e \u2192 Outils de la plate-forme \u2192 External Client Apps \u2192 External Client App Manager',
      'Cliquez \u00AB New External Client App \u00BB et remplissez les infos de base',
      'Activez OAuth avec les scopes \u00AB G\u00E9rer les donn\u00E9es utilisateur via des API (api) \u00BB et \u00AB Effectuer des requ\u00EAtes \u00E0 tout moment (refresh_token, offline_access) \u00BB',
      'URL de rappel : https://app.baakal.ai/api/crm/salesforce/callback',
      'Cr\u00E9ez l\u2019app, puis ouvrez-la : Settings \u2192 OAuth Settings \u2192 Consumer Key and Secret',
      'Collez ci-dessous l\u2019URL de votre instance, la Consumer Key et le Consumer Secret',
    ],
    guideEn: [
      'In Salesforce: Setup \u2192 Open Advanced Setup \u2192 Platform Tools \u2192 External Client Apps \u2192 External Client App Manager',
      'Click \u201CNew External Client App\u201D and fill in the basic information',
      'Enable OAuth with the \u201CManage user data via APIs (api)\u201D and \u201CPerform requests at any time (refresh_token, offline_access)\u201D scopes',
      'Callback URL: https://app.baakal.ai/api/crm/salesforce/callback',
      'Create the app, then open it: Settings \u2192 OAuth Settings \u2192 Consumer Key and Secret',
      'Paste your instance URL, Consumer Key and Consumer Secret below',
    ],
    link: null,
  },
  odoo: {
