...
const I18N = {
  fr: {
    ...
    prosp: {
      eyebrow: "ET SI TU VEUX — PROSPECTION", title_a: "L'outbound aussi. ", title_em: "Mais ce n'est pas", title_b: " le produit.",
      sub: "baakalai sait aussi créer des campagnes outbound. Mais la vraie valeur, c'est ce qui se passe après — quand le lead entre dans ton CRM.",
      list: [
    ...
    book: {
      ...
      points: [
        "Audit gratuit de ton pipeline — on te dit combien de deals dorment",
  ...
  en: {
    ...
    prosp: {
      eyebrow: "AND IF YOU WANT — PROSPECTION", title_a: "Outbound too. ", title_em: "But that's not", title_b: " the product.",
      sub: "baakalai can also build outbound campaigns. But the real value is what happens after — when the lead enters your CRM.",
      list: [
